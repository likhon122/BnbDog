...
const OverlayPage: React.FC<OverlayPageProps> = ({
  ...
  const fetchYearsAgo = async () => {
    ...
    try {
      ...
      const url = `https://gotem-db.onrender.com/get_creation_month_count?userid=${userID}`;
  ...
  const FinalPage3 = () => {
    return (
      ...
      >
        ...
        {/* Top Text */}
        <div className="mt-8">
          <p>Come back tomorrow for check-in bonus!</p>
        </div>
        ...
        <div className="mb-6 text-center">
          ...
          <p>Every month you'll have chances to win</p>
          <p>💰Season 1: $50,000 USD! (December 31th)</p>
          <p>💰Season 2: $100,000 USD! (January 30th)</p>
          <p>💰Season 3: $150,000 USD! (February 28th)</p>
          <p>Next Season Coming Soon</p>
